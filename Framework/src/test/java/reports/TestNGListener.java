...
public class TestNGListener implements ITestListener, IClassListener {
    ...
    public TestNGListener() {
        ...
        ConnectionProfile profile = PropertiesLoader.getConnectionProfile();
    ...
    public void onTestFailure(ITestResult testResult) {
        ...
        if(testResult.getThrowable() != null) {
            TestModellerLogger.FailStepWithScreenshot( tb.getSession(),"Test Failed", testResult.getThrowable().getMessage());
        } else {
            TestModellerLogger.FailStepWithScreenshot( tb.getSession(),"Test Failed", "");
        }
    ...
    public void onTestSuccess(ITestResult testResult) {
        ...
        TestModellerLogger.PassStepWithScreenshot( tb.getSession(),"Test Passed");
